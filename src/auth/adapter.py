...
class SocialAccountAdapter(DefaultSocialAccountAdapter):
    """
    Copying and pasting all the code from DefaultSocialAccountAdapter
    so I can add various print statements.
    Fuctionality has not been changed in any way.
    """
